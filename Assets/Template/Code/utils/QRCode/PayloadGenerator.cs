...
//            /// <param name="city">CityEntityCity</param>
...
//            /// Default: European format, ([Street] [House Number] and [Postal Code] [CityEntityCity]
//            /// Reversed: North American and others format ([House Number] [Street] and [CityEntityCity] [Postal Code])
//            /// </summary>
...
//                /// <param name="city">CityEntityCity name</param>
...
//                        throw new SwissQrCodeContactException("CityEntityCity must not be empty.");
//                    if (city.Length > 35)
//                        throw new SwissQrCodeContactException("CityEntityCity name must be shorter than 36 chars.");
//                    if (!Regex.IsMatch(city, charsetPattern))
//                        throw new SwissQrCodeContactException($"CityEntityCity name must match the following pattern as defined in pain.001: {charsetPattern}");
//                    this.city = city;
